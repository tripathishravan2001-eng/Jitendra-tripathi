...
/* ── Globals ── */
let selectedService = "";
let dynamicPhone = "91XXXXXXXXXX"; // Used for WhatsApp links
    ...
    try {
        ...
        if(settings.tagline) {
            ...
            if(settings.phoneNumber) {
                ...
                if(el) el.textContent = settings.phoneNumber;
            }
            if(settings.whatsappNumber) {
                const el = document.querySelector('#contact-whatsapp p');
                if(el) el.textContent = "+" + settings.whatsappNumber;
                dynamicPhone = settings.whatsappNumber;
            }
